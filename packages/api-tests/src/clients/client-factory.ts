...
export class ClientFactory {
   ...
   */
  public static createGithubStyleOrganizationAuthClient() {
   ...
   */
  public static createSlackStyleOrganizationAuthClient() {
   ...
   */
  public static createOrganizationPermissionsClient() {
